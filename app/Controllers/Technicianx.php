...
class Technician extends BaseController
{
    ...
    public function all_technician($data_type = "on-progress")
    {
        ...
        switch ($data_type) {
            case "on-progress":
                $technician = $this->technician_model->getAllDataOrderForTechnicianOnProgress();
                $checked_button = "<script>radiobtn = document.getElementById('btnradio1');radiobtn.checked = true;</script>";
                break;
            case "done-this-month":
                $technician = $this->technician_model->getAllDataOrderForTechnicianDoneThisMonth($month, $year);
                $checked_button = "<script>radiobtn = document.getElementById('btnradio2');radiobtn.checked = true;</script>";
                break;
            case "done-all":
                $technician = $this->technician_model->getAllDataOrderForTechnicianDone();
                $checked_button = "<script>radiobtn = document.getElementById('btnradio2');radiobtn.checked = true;</script>";
                break;
        }
