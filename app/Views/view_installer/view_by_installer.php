        ...
        <div class="row">
            <div class="col-xl-12 col-md-12" id="container-card">
                <?php foreach ($listUser as $row) :
                    $data_order_installer = $order_installer->getAllDataOrderByUserId("monthly", $row["id_user"]);
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($data_order_installer as $row2) : ?>
                                                <tr>
                                                    ...
                                                    <td><?= getStatusName($row2["id_status"]) ?></td>
        ...
        $("#btn-all-done").on("click", function() {
            ...
            $.ajax({
                ...
                responseAjax.forEach(installation => {
                    filterDone(`/api/installation-by/all/${installation.id_user}`, installation.fullname, containerCard);
                })
