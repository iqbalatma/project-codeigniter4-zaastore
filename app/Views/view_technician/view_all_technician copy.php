        ...
        <div class="row">
            <div class="col-xl-12 col-md-12">
                ...
                <div class="btn-group mb-3" role="group" aria-label="Basic radio toggle button group">
                    ...
                    <a href="/technician-all/on-progress" class="btn btn-outline-primary" for="btnradio1">Belum Selesai</a>


                    <input type="radio" class="btn-check" name="btnradio" id="btnradio2" autocomplete="off">
                    <a class="btn btn-outline-primary" href="/technician-all/done-this-month" for="btnradio2">Sudah Selesai</a>
                </div>
                ...
                ?>
                    <!-- SEPARATOR -->
                    <br><br>
                    <form action="/technician-all/done-this-month" method="GET">
                        <div class="row mb-4">
                            ...
                            <div class="col-xl-4 col-md-4">
                                ...
                                <?php if ($data_type == "done_all") {
                                ?>
                                    <a href="/technician-all/done-this-month" class="btn btn-primary">Tampilkan Data Bulan Ini</a>
                                    <!-- <a href="<?php //base_url("PDF/print_pdf?title=Pengerjaan Semua Teknisi&view=pdf_all_technician&data_type=done_all");  -->
                                                    ?>" class="btn btn-primary">Cetak PDF Seluruh Data Teknisi</a> -->
                                <?php
                                } else {
                                ?>
                                    <a href="/technician-all/done-all" class="btn btn-primary">Tampilkan Semua Data</a>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="<?= base_url("PDF/print_pdf"); ?>" method="GET">
                                    <div class="row mb-4">
                                        <input type="hidden" name="title" value="Pengerjaan Semua Teknisi">
                                        <input type="hidden" name="view" value="pdf_all_technician">
                            ...
                            foreach ($technician as $row) : ?>
                                <tr>
                                    ...
                                    ?>
                                        <td>
                                            <!-- Button trigger modal -->
                                            <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#ganti_teknisi<?= $row['id_order']; ?>">
                                                Ganti Teknisi
                                            </button>

                                            <!-- Modal -->
                                            <div class="modal fade" id="ganti_teknisi<?= $row['id_order']; ?>" tabindex="-1" aria-labelledby="ganti_teknisi<?= $row['id_order']; ?>Label" aria-hidden="true">
                                                        ...
                                                        <form action="/technician-update-technician" method="POST">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <select class="form-select" aria-label="Default select example" id="technician" name="technician">
                                                                    <?php foreach ($technician_user as $row2_technician) :

                                                                        if ($row["id_technician"] == $row2_technician["id_user"]) {
                                                                    ?>
                                                                            <option selected value="<?= $row2_technician["id_user"]; ?>"><?= $row2_technician["fullname"]; ?></option>
                                                                        <?php
                                                                        } else {
                                                                        ?>
