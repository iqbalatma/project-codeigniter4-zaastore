    ...
    <div class="container-fluid px-4">
        ...
        <div class="row">
            <div class="col-xl-12 col-md-12">
                ...
                <br><br>
                <form action="/technician-by/done-this-month" method="GET">
                    <div class="row mb-4">
                        ...
                        <div class="col-xl-4 col-md-4">
                            ...
                            ?>
                                <a href="/technician-by/done-this-month" class="btn btn-primary">Tampilkan Data Bulan Ini</a>
                                <!-- <a href="<?php //echo base_url("PDF/print_pdf?title=Pengerjaan Semua Teknisi&view=pdf_by_technician&data_type=done_all");  -->
                                                ?>" class="btn btn-primary">Cetak PDF Seluruh Data Teknisi</a>-->
                            <?php
                            } else {
                            ?>
                                <a href="/technician-by/done-all" class="btn btn-primary">Tampilkan Semua Data</a>
                            ...
                            <div class="modal-body">
                                <form action="<?= base_url("PDF/print_pdf"); ?>" method="GET">
                                    <div class="row mb-4">
                                        ...
                                        <input type="hidden" name="view" value="pdf_by_technician">
